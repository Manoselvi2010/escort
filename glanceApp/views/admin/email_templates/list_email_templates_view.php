                           ...
                           <table id="example1" class="table table-bordered table-striped">
                              ...
                              <tbody id="sect">
                                 ...
                                 <tr id="row_<?php echo $row->ID;?>">
                                    ...
                                    <td>
                                       <a href="<?php echo base_url('admin/'.$page_name.'/preview/'.$row->ID);?>" target="_blank" class="btn btn-default btn-xs btn-blue ">Preview</a>
                                       <a href="<?php echo base_url('admin/'.$page_name.'/update/'.$row->ID);?>" class="btn btn-primary btn-xs btn-pink">Edit</a> 
                                    </td>
                                 </tr>
