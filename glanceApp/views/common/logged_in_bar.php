      ...
      <div class="container">
          ...
          <div class="col-md-6" >
            ...
            <ul class="usernav">
              ...
              <li class="dropdown"><a href="#" class="dropdown-toggle" title="Settings" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"><i class="fa fa-cog" aria-hidden="true" style="padding: 3px 3px !important"></i></a>
