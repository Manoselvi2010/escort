				...
				?>
                	<li class="col-md-4">
                        ...
                        <div class="profileInfo">
                            ...
                            <?php if(isset($searchDetail->gender)){?>
                                <p><i class="fa fa-user" aria-hidden="true"></i> <?php echo $searchDetail->gender;?></p>
                            <?php } if(isset($searchDetail->mAge)){?>
                                <p><i class="fa fa-history" aria-hidden="true"></i> <?php echo $searchDetail->mAge;?> yrs</p>
                            <?php } if(isset($searchDetail->height)){?>
                                <p><i class="fa fa-header" aria-hidden="true" style="font-size: 10px"></i> <?php echo $searchDetail->height;?></p>
                            <?php } if(isset($searchDetail->weight)){?>
                                <p><i class="fa fa-female" aria-hidden="true"></i> <?php echo $searchDetail->weight;?></p>
                             <?php } if(isset($searchDetail->breast_size)){?>
                                <p><i class="fa fa-female" aria-hidden="true"></i> <?php echo $searchDetail->breast_size;?></p>
                            <?php } if(isset($searchDetail->country)){?>
                                <p><i class="fa fa-map-marker" aria-hidden="true"></i> <?php echo $searchDetail->country;?></p>
                            <?php } ?>
