            ...
            <div class="signupBox">
                ...
                <div class="formboxWrap">
                  <form name="frm" id="frm" method="post" action="">
                    ...
                    <div class="accept">
                      <div class="terms">By signup you agree to our <a href="<?php echo base_url();?>terms">Terms and Conditions</a></div>              
                    </div>
...
<div class="howitwrap">
    <div class="container">
        ...
        <ul class="row howtolist">
            <li class="col-md-4 col-sm-4">
                <div class="icon"><img src="<?php echo base_url(); ?>glancePublic/images/profile.png"></div>
            ...
            <li class="col-md-4 col-sm-4">
                <div class="icon"><img src="<?php echo base_url(); ?>glancePublic/images/match.png"></div>
                <h5>Search Matches</h5>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec sagittis neque quis maximus tempor. </p>
            </li>
            <li class="col-md-4 col-sm-4">
                <div class="icon"><img src="<?php echo base_url(); ?>glancePublic/images/dating.png"></div>
                <h5>Start Dating</h5>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec sagittis neque quis maximus tempor. </p>
            </li>
        </ul>
  ...
  <div class="recentWraper">
    ...
    <ul class="featuredListing row">
      ...
      if($val->photo)
        $image_thumb = base_url().'glancePublic/uploads/member_images/'.$val->photo;
      else
        ...
        <div class="profileBox">
            ...
            <div class="profileInfo">
                ...
                <?php if(isset($val->phone) && !empty($val->phone)){?>
                    <p><i class="fa fa-play" aria-hidden="true"></i> Phone: <?php echo $val->phone;?></p>
                <?php } if(isset($val->gender) && !empty($val->gender)){?>
                    <p><i class="fa fa-play" aria-hidden="true"></i> Gender: <?php echo $val->gender;?></p>
                <?php }  if(isset($val->dob) && !empty($val->dob)){?>
                    <p><i class="fa fa-play" aria-hidden="true"></i> Age: <?php echo count_years($val->dob,date("Y-m-d"));?> yrs</p>
                <?php }  if(isset($val->height) && !empty($val->height)){?>
                    <p><i class="fa fa-play" aria-hidden="true"></i> Height: <?php echo $val->height;?> cm</p>
                <?php } if(isset($val->weight) && !empty($val->weight)){?>
                    <p><i class="fa fa-play" aria-hidden="true"></i> Weight: <?php echo $val->weight;?> kg</p>
                 <?php } if(isset($val->breast_size) && !empty($val->breast_size)){?>
                    <p><i class="fa fa-play" aria-hidden="true"></i> Breast Size: <?php echo $val->breast_size;?></p>
                <?php } if(isset($val->one_hour_apartment) && !empty($val->one_hour_apartment)){?><p><i class="fa fa-play" aria-hidden="true"></i> 1hour: <?php echo $val->one_hour_apartment;?></p>
                <?php } if(isset($val->two_hours_apartment) && !empty($val->two_hours_apartment)){?><p><i class="fa fa-play" aria-hidden="true"></i> 2hour: <?php echo $val->two_hours_apartment;?></p>
                <?php } if(isset($val->country) && !empty($val->country)){?>
                    <p><i class="fa fa-play" aria-hidden="true"></i> Country: <?php echo $val->country;?></p>
                <?php } ?>
                <!-- <p><i class="fa fa-map-marker" aria-hidden="true"></i> <?php echo $val->one_hour_apartment;?></p> -->
            </div>
            <div class="row " align="right">
               <div class="col-md-12">
                  <a href="<?php echo base_url(); ?>profile/<?php echo $val->username; ?>" class="btn pink-color-btn">Detail</a>
