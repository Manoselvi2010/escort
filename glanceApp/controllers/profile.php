...
class Profile extends CI_Controller {
	...
	public function index($username){
		...
		if($profile_row){
			...
			$member_services = $this->member_model->get_member_service($profile_row->id);
			
			$services = $this->member_model->get_profile_service();
			$member_cities = $this->member_model->get_member_city($profile_row->city,$profile_row->id);
			...
			$data['member_cities'] = $member_cities;
